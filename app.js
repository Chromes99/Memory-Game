//Putting all the cards in a deck
...
// Difficulty settings this is the max move per star
let hard = 10;
let medium = 20;
...
// Interval function called every second, increments timer and updates HTML
let startTimer = function() {
    ...
    // Single second digits start with zero
    let formattedSec = "0";
    if (timer.seconds < 10) {
...
// Resets timer and restarts timer
function resetTimer() {
...
// Updates number of moves in the HTML, removes star as necessary based on difficulty variables
...
// Checks to see if both cards that face up match
function checkMatch() {
...
// Changes everything back to normal state
...
// Cards will be random on loading the game
$(updateCards);
